 ...
 * @author Wind
 */
public class ItemManagementView extends javax.swing.JFrame {

    DefaultTableModel itemTableModel;
    List<ItemDTO> items;

    /**
     * Creates new form ItemManagementView
     */
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if (index != -1) {
            int itemID = (int) itemTableModel.getValueAt(index, 0);
            boolean result2 = Controller.getInstance().deleteOrderItemByItemID(itemID);
            System.out.println(result2);
            boolean result = Controller.getInstance().deleteItem(itemID);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new ItemCreateForm(this).setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int index = itemTable.getSelectedRow();
        if (index != -1) {
            ItemDTO itemSelected = new ItemDTO((int) itemTableModel.getValueAt(index, 0), (int) itemTableModel.getValueAt(index, 2), (int) itemTableModel.getValueAt(index, 3), (String) itemTableModel.getValueAt(index, 1));
            new UpdateItemView(itemSelected, this).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemManagementView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ItemManagementView().setVisible(true);
            }
        });
    }
